...
# Análisis Temporal
# Agrupar el conteo de registros por día
...
# Top Palabras Clave (Generación Z)
# Filtrar el texto y combinar Comentarios/Resúmenes de Gen Z
...
# Top Palabras Clave (Frankenstein)
...
# Re-definir diccionarios de sentimiento
sentimiento_genz = {
...
def calcular_tono(texto, diccionario):
    ...
    puntaje = 0
    # Iterar sobre las palabras positivas y sumar el conteo
    for palabra in diccionario['Positivo']:
        puntaje += texto_limpio.count(palabra)
        
    # Iterar sobre las palabras negativas y restar el conteo
...
# Visualización del Tono de Sentimiento
...
# Análisis de Plataformas Mencionadas 
